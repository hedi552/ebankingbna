...
import { sampleWithRequiredData } from '../virement.test-samples';
...
describe('Virement Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.virements()[0]).toEqual(expect.objectContaining({ id: 13388 }));
  });

  describe('trackId', () => {
    it('should forward to virementService', () => {
      const entity = { id: 13388 };
      jest.spyOn(service, 'getVirementIdentifier');
      const id = comp.trackId(entity);
      expect(service.getVirementIdentifier).toHaveBeenCalledWith(entity);
