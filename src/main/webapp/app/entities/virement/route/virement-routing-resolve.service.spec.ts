...
import virementResolve from './virement-routing-resolve.service';

describe('Virement routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: VirementService;
  let resultVirement: IVirement | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IVirement returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        virementResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultVirement).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IVirement>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
