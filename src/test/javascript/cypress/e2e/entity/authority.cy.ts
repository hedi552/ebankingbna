...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'bc7ffc86-4c3a-4aa8-b205-3082180f47c5' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('45a5e595-8594-4281-b791-7fd0e92d7b25');
      cy.get(`[data-cy="name"]`).should('have.value', '45a5e595-8594-4281-b791-7fd0e92d7b25');
